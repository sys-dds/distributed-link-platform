# Failure Drill: Kafka Unavailable During Click Analytics

## Premise

Kafka unavailable should not corrupt redirect correctness; analytics freshness should show delay/degradation.
