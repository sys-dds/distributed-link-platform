...
class OpsStatusControllerIntegrationTest {
    ...
    void opsReadCanFetchStatusAndResponseUsesRealWorkspaceScopedState() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/ops/status")
                ...
                .andExpect(jsonPath("$.pipelines.analytics.oldestEligibleAgeSeconds").isNumber())
                .andExpect(jsonPath("$.pipelines.analytics.oldestParkedAgeSeconds").isNumber())
                ...
                .andExpect(jsonPath("$.pipelines.lifecycle.parkedCount").value(1))
